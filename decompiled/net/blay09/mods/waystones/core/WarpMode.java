...
public enum WarpMode {
    ...
    private static boolean waystoneIsActivatedOrNamed(Entity player, IWaystone waystone) {
        return WaystonesConfig.getActive().getInventoryButtonMode().hasNamedTarget() || waystone.getWaystoneType().equals((Object)WaystoneTypes.WAYSTONE) && player instanceof Player && PlayerWaystoneManager.isWaystoneActivated((Player)player, waystone);
    }

    private static boolean waystoneIsActivated(Entity player, IWaystone waystone) {
        return waystone.getWaystoneType().equals((Object)WaystoneTypes.WAYSTONE) && player instanceof Player && PlayerWaystoneManager.isWaystoneActivated((Player)player, waystone);
    }
